...
SELECT cars_engine AS \"engine\", cars_price AS \"price\", tbl_models.models_name AS \"model\", tbl_modeltypes.modeltypes_name AS \"modelType\", cars_img AS \"imageUrl\" , cars_trans AS \"trans\", cars_speed AS \"speed\" 
FROM tbl_cars 
